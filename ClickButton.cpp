...
ClickButton::ClickButton (uint8_t pin) 
{
	_antirrebotes = 30;            		// tiempo para evitar rebotes en ClickButtones mecanicos
...
ClickButton::ClickButton (uint8_t pin, uint8_t antirrebotes, uint16_t corta, uint16_t larga ) 
{
	_antirrebotes = antirrebotes;      	// tiempo para evitar rebotes en ClickButtones mecanicos
